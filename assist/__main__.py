...
def main(argv=None):
    ...
    try:
        if args.cmd=="plan":
            ...
            plan=make_plan(args.suite,args.split,args.seed)
        ...
        summary=execute(plan,args.out,DEFAULT,llm_cfg,args.allow_jev_paid,args.allow_llm_paid,args.question_language)
